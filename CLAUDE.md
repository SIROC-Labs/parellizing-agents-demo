...
- **worktree directory**: `../<branch-slug>` relative to this repo. Example: `../add-campaign-filters`
...
```bash
git worktree add ../<branch-slug> -b feature/<slug>
```
...
Work inside the worktree directory (`../<branch-slug>`).
...
- The original repo (`parallel-agents-demo/`) is the base. Treat it as read-only during task execution.
